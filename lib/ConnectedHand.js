  ...
  ConnectedHand.prototype.placePalm = function( hand , fingers ){
    ...
    */
    ...
    console.log("finger1");
    this.palm.joints[1].position  = this.leapToScene1( fingers[1].mcpPosition );
...
ConnectedHand.prototype.leapToScene1 = function( position ){
  ...
  function manupulator(position){
   /* var currentframe= function(frame){
  // Display Gesture object data
  if (frame.gestures.length > 0) {
      var gesture = frame.gestures[0];
      if(gesture.type() == TYPE_SCREEN_TAP) {*/
         var posString=position[0]+" "+position[1]+" "+position[2];
    console.log(position[0]);
     
    var r=document.getElementById('region');
    r.innerText=posString;
    if(position[1]>-40 && position[1] <= -31)
     {//document.getElementById("audio").src='sounds/e2.mp3';
                  document.getElementById("audio1").play();
    }
      if(position[1] > -31 && position[1]<=-22)
       {//document.getElementById("audio").src='sounds/b.mp3';
                  document.getElementById("audio2").play();
    } 
        if(position[1]>-22 && position[1]<=-13)
       {//document.getElementById("audio").src='sounds/g.mp3';
                  document.getElementById("audio3").play();
      }
        
          if(position[1]>-13 && position[1]<=-4)
       {//document.getElementById("audio").src='sounds/d.mp3';
                  document.getElementById("audio4").play();
          }
            if(position[1]>-4 && position[1]<=8)
       {//document.getElementById("audio").src='sounds/a.mp3';
                  document.getElementById("audio5").play();
    }
            
              if(position[1]>8 && position[1]<=15)
       {//document.getElementById("audio").src='sounds/e1.mp3';
